...
class Settings:
    ...
    regular_auto_result_smtp_server: str = _env("REGULAR_AUTO_RESULT_SMTP_SERVER", _env("PASSWORD_RESET_SMTP_SERVER", "smtp.gmail.com"))
    regular_auto_result_smtp_port: int = _env_int("REGULAR_AUTO_RESULT_SMTP_PORT", _env_int("PASSWORD_RESET_SMTP_PORT", 587))
    regular_auto_result_smtp_user: str = _env("REGULAR_AUTO_RESULT_SMTP_USER", _env("EMAIL_ID") or _env("PASSWORD_RESET_SMTP_USER", _env("EMAIL_ID").split("@")[0]))
    regular_auto_result_smtp_pw: str = _env("REGULAR_AUTO_RESULT_SMTP_PW", _env("EMAIL_PW") or _env("PASSWORD_RESET_SMTP_PW", _env("EMAIL_PW")))
