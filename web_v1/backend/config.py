...
class Settings:
    ...
    password_reset_smtp_user: str = _env("PASSWORD_RESET_SMTP_USER", "admpdm")
    ...
    regular_auto_result_from: str = _env("REGULAR_AUTO_RESULT_FROM", _env("PASSWORD_RESET_FROM", "admpdm@dae-seung.co.kr"))
    ...
    regular_auto_result_smtp_user: str = _env("REGULAR_AUTO_RESULT_SMTP_USER")
    regular_auto_result_smtp_pw: str = _env("REGULAR_AUTO_RESULT_SMTP_PW")
