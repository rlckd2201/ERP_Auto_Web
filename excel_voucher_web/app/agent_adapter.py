...
def _run_real_erp_voucher_task(
    ...
    *,
    ...
    os.environ["ERP_VERIFY_GRID_PASTE"] = "0"
    os.environ["ERP_ALLOW_UNVERIFIED_GRID_SAVE"] = "1"
    os.environ["ERP_NEW_CLICK_COUNT"] = "2"
    os.environ["ERP_FAST_INPUT"] = "1"
    os.environ["ERP_FAST_FIELD_VERIFY"] = "0"
    ...
    # 2px 간격으로 얇은 GDI 글자/구분선을 놓치지 않게 확인하고 동일한 결과가 두 번
    # 연속일 때만 준비 완료로 판정한다.
    os.environ["ERP_MGMT_VISUAL_SCAN_STEP"] = "2"
    ...
    os.environ["ERP_MGMT_KEY_WAIT"] = "0.08"
    os.environ["ERP_MGMT_COMMIT_WAIT"] = "0.15"
    os.environ["ERP_MGMT_FOCUS_WAIT"] = "0.10"
    os.environ["ERP_MGMT_CLICK_WAIT"] = "0.10"
    os.environ["ERP_MGMT_CLIPBOARD_WAIT"] = "0.05"
    os.environ["ERP_MGMT_F9_OPEN_WAIT"] = "1.50"
    os.environ["ERP_MGMT_F9_SEARCH_WAIT"] = "1.50"
    os.environ["ERP_MGMT_F9_KEY_INTERVAL"] = "0.12"
    os.environ["ERP_MGMT_F9_GROUP_WAIT"] = "0.20"
    os.environ["ERP_MGMT_F9_ENTER_INTERVAL"] = "0.30"
    os.environ["ERP_MGMT_F9_RETURN_TIMEOUT"] = "6.0"
    os.environ["ERP_MGMT_VENDOR_DS_SEARCH_Y"] = "56"
    os.environ["ERP_MGMT_SUMMARY_OPEN_WAIT"] = "0.35"
    os.environ["ERP_MGMT_AFTER_SUMMARY_OPEN_WAIT"] = "0.15"
    os.environ["ERP_VENDOR_POPUP_OPEN_WAIT"] = "0.70"
    os.environ["ERP_VENDOR_POPUP_FOCUS_WAIT"] = "0.20"
    os.environ["ERP_VENDOR_POPUP_SEARCH_WAIT"] = "0.20"
    os.environ["ERP_MENU_STEP_WAIT"] = "0.75"
    os.environ["ERP_MENU_TREE_WAIT"] = "0.35"
    os.environ["ERP_MENU_ENTRY_SETTLE_WAIT"] = "0.60"
    os.environ["ERP_DS_MENU_COORDINATE_ONLY"] = "1"
    os.environ["ERP_DS_ACCOUNTING_TILE_X"] = "304"
    os.environ["ERP_DS_ACCOUNTING_TILE_Y"] = "201"
    os.environ["ERP_DS_SLIP_ROOT_Y"] = "137"
    os.environ["ERP_DS_SLIP_ROW_H"] = "29"
    os.environ["ERP_DS_SLIP_ROOT_X"] = "105"
    os.environ["ERP_DS_SLIP_PROCESS_X"] = "126"
    os.environ["ERP_DS_SLIP_ENTRY_X"] = "155"
    os.environ["ERP_STRICT_FORM_STEPS"] = "1"
    os.environ["ERP_CRITICAL_FIELD_WAIT"] = "0.35"
    os.environ["ERP_FORM_STEP_WAIT"] = "0.25"
