...
def _run_real_erp_voucher_task(
    ...
    *,
    ...
    os.environ["ERP_MGMT_CLICK_WAIT"] = "0.06"
    os.environ["ERP_MGMT_CLIPBOARD_WAIT"] = "0.02"
    os.environ["ERP_MGMT_SUMMARY_OPEN_WAIT"] = "0.20"
    os.environ["ERP_MGMT_AFTER_SUMMARY_OPEN_WAIT"] = "0.05"
    os.environ["ERP_VENDOR_POPUP_OPEN_WAIT"] = "0.35"
    os.environ["ERP_VENDOR_POPUP_FOCUS_WAIT"] = "0.10"
    os.environ["ERP_VENDOR_POPUP_SEARCH_WAIT"] = "0.20"
    os.environ["ERP_MENU_STEP_WAIT"] = "0.45"
    os.environ["ERP_MENU_TREE_WAIT"] = "0.18"
    os.environ["ERP_MENU_ENTRY_SETTLE_WAIT"] = "0.30"
    os.environ["ERP_DS_MENU_COORDINATE_ONLY"] = "1"
    os.environ["ERP_DS_ACCOUNTING_TILE_X"] = "304"
    os.environ["ERP_DS_ACCOUNTING_TILE_Y"] = "201"
    os.environ["ERP_DS_SLIP_ROOT_Y"] = "150"
    os.environ["ERP_DS_SLIP_ROW_H"] = "35"
