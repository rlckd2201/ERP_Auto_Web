...
```powershell
$env:EXCEL_VOUCHER_GROUPWARE_DB_USER = "읽기전용계정"
$env:EXCEL_VOUCHER_GROUPWARE_DB_PASSWORD = "읽기전용비밀번호"
$env:EXCEL_VOUCHER_SMTP_HOST = "smtp.example.local"
$env:EXCEL_VOUCHER_SMTP_FROM = "finance-system@example.local"
...
SMTP 값이 없으면 메일은 실제 발송되지 않고 `data/mail_outbox`에 JSON으로 보관된다.
