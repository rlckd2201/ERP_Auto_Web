...
## Corpus Check
- 229 files · ~246,024 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1190 nodes · 3821 edges · 30 communities detected
...
Cohesion: 0.06
Nodes (65): _add_installer_file(), _add_installer_tree(), _agent_bootstrap_script(), _agent_cmd_launcher(), _agent_exe_launcher(), _agent_installer_script(), _agent_self_contained_cmd(), api_agent_job_event() (+57 more)
...
Cohesion: 0.14
Nodes (35): api_agent_heartbeat(), api_agent_setup_install_complete(), api_setup_installer(), _active_install_job(), _add_check(), _age_seconds(), authenticate_user(), claim_install_job() (+27 more)
...
- **Why does `WehagoHandler` connect `Community 0` to `Community 8`, `Community 7`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `BaseTaxInvoiceHandler` connect `Community 0` to `Community 19`, `Community 20`, `Community 13`, `Community 7`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `JobStore` connect `Community 1` to `Community 2`?**
...
- **Are the 25 inferred relationships involving `get_invoice()` (e.g. with `_active_invoice_items()` and `claim_next_erp_task()`) actually correct?**
  _`get_invoice()` has 25 INFERRED edges - model-reasoned connections that need verification._
