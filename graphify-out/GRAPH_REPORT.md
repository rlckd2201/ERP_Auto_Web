...
## Corpus Check
- 111 files · ~172,857 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2481 nodes · 7222 edges · 182 communities (143 shown, 39 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 627 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7eca0c56`
...
Cohesion: 0.21
Nodes (20): JobStore, StreamingResponse, api_delete_invoice(), api_get_invoice(), api_get_invoice_logs(), api_list_invoices(), api_retry_invoice(), create_demo_job() (+12 more)

### Community 1 - "main.py"
Cohesion: 0.11
Nodes (50): _agent_payload(), api_admin_agent_commands(), api_admin_create_agent_command(), api_admin_reset_jobs(), api_admin_server_update(), api_agent_job_artifact(), api_agent_job_complete(), api_agent_job_event() (+42 more)
...
Cohesion: 0.17
Nodes (14): create_purchase_analyze_job(), JobEvent, JobRecord, JobStore, datetime, utc_now(), InvoiceIdsRequest, JobCreateRequest (+6 more)
...
### Community 10 - "app.py"
Cohesion: 0.09
Nodes (57): HTMLResponse, _add_installer_file(), _add_installer_tree(), _admin_db_conn(), admin_db_page(), _admin_table_names(), _agent_installer_script(), _agent_self_contained_cmd() (+49 more)
...
Cohesion: 0.06
Nodes (75): _connection_error_message(), _download_job_source(), _execute_admin_command(), _heartbeat(), _install_agent_task(), _latest_agent_log(), main(), _normalize_printer_name() (+67 more)

### Community 17 - "erp_agent.py"
Cohesion: 0.08
Nodes (50): CompletedProcess, _acquire_single_instance(), _agent_bundle_hash(), _agent_update_required(), AgentTray, _apply_server_setup_config(), _cert_cache_path(), _cert_store_has_thumbprint() (+42 more)
...
Cohesion: 0.09
Nodes (74): _check_playwright_runtime(), fetch_approval_documents(), Any, Progress, build_purchase_erp_payload(), build_regular_erp_payload(), _clean_text(), _configure_pyautogui_for_server() (+66 more)
...
Cohesion: 0.13
Nodes (23): AccountStore, AccountUser, hash_password(), now_text(), protect_secret(), Any, Connection, Path (+15 more)
...
Cohesion: 0.10
Nodes (28): _FakeControl, _FakeLogger, _FakeRect, _load_nested_functions(), test_advance_grid_row_refreshes_once_at_dynamic_bottom_then_reuses_anchor(), test_advance_grid_row_stops_when_expected_row_is_missing_after_refresh(), test_dynamic_next_row_reuses_24_or_26_row_bottom_anchor(), test_finance_direct_vendor_waits_before_enter_and_before_next_row() (+20 more)
...
Cohesion: 0.36
Nodes (15): BaseModel, api_agent_admin_complete(), AdminAgentCommandRequest, AdminResetJobsRequest, AgentAdminCommandCompleteRequest, AgentCompleteRequest, AgentEventRequest, BankTransfer (+7 more)
...
Cohesion: 0.16
Nodes (35): api_agent_job_complete(), api_agent_job_expense_report_upload(), api_agent_job_voucher_upload(), api_analyze_purchase(), api_create_manual_purchase_invoice(), api_generate_expense_report(), api_get_invoice_output_set(), api_update_purchase_analysis() (+27 more)
...
Cohesion: 0.13
Nodes (28): JSONResponse, _agent_bootstrap_script(), _agent_cmd_launcher(), _agent_exe_launcher(), api_agent_job_event(), api_agent_next_task(), api_login(), api_password_change_initial() (+20 more)
...
Cohesion: 0.15
Nodes (11): _is_sane_amount(), _detect_erp_target_monitor(), _ErpGuiAutomationLock, ERPLoginBot, _monitor_summary(), _move_window_to_erp_monitor(), Logger, 분개전표입력 화면 자동 세팅 (v6.1 - Clipboard & UI ID Independence) (+3 more)

### Community 90 - ".load_server_invoice"
Cohesion: 0.23
...
- **Why does `run_invoice_erp_input()` connect `erp_runner.py` to `worker.py`, `전표 자동화 프로그램(담당자용)_v6.2.py`, `RuntimeError`, `erp_agent.py`, `api_admin_db_overview`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `SmileEdiHandler` connect `SmileEdiHandler` to `parse_tax_invoice_xml`, `BaseTaxInvoiceHandler`?**
