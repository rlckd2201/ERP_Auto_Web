...
## Corpus Check
- 1938 files · ~3,504,201 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4750 nodes · 37078 edges · 66 communities detected
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3051 edges (avg confidence: 0.79)
...
- `api_list_invoices()` --calls--> `list_invoices()`  [INFERRED]
  _codex_app_zoom_agent_ascii_patch.py → C:\Users\user\Desktop\개발파일\회계업무 자동화_WEB_Version\_release_fix9_stage\web_v1\backend\invoice_db.py

## Communities

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (746): _legacy_form_data(), _legacy_site_name(), add_invoice_log(), get_invoice(), update_invoice_json(), JobCreateRequest, build_output_set_status(), RuntimeError (+738 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (25): _active_invoice_items(), claim_next_erp_task(), now_text(), _read_task(), _task_files(), update_erp_task(), _write_task(), queue_dir() (+17 more)
...
Cohesion: 0.09
Nodes (51): _app_version(), _env(), _env_bool(), _env_int(), _legacy_manager_path(), _load_env_file(), Settings, _version_file_default() (+43 more)
...
Cohesion: 0.06
Nodes (10): decode_mime_header(), extract_target_links(), InvoiceMailWatcher, log(), read_part_text(), _split_csv(), portal_name(), LG U+ eDocu tax invoice portal adapter.  This adapter intentionally routes edo (+2 more)
...
Cohesion: 0.2
Nodes (42): _clean_int(), _columns(), delete_invoice(), detect_invoice_type(), _ensure_column(), get_conn(), get_invoice_by_pdf_path(), init_db() (+34 more)

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (22): BaseTaxInvoiceHandler, 메일 본문에서 법인 키워드를 찾아 사업자번호 후보 dict 반환., HometaxHandler, _parse_amount(), _parse_field(), portal_name(), _write_text(), _build_data() (+14 more)
...
Cohesion: 0.25
Nodes (64): _connection_error_message(), _heartbeat(), main(), _post(), run_loop(), _archive_pdf(), _file_uri(), _find_browser_for_pdf() (+56 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (94): applyAuthUi(), badge(), canUseApp(), changePassword(), escapeHtml(), fetchJson(), forgotPassword(), formatAge() (+86 more)
...
## Knowledge Gaps
- **58 isolated node(s):** `DueRule`, `DueContact`, `DueRule`, `DueContact`, `Placeholder for the real ERP UI automation run on the automatic voucher PC Agent` (+53 more)
...
- **Thin community `Community 54`** (1 nodes): `캐시된 드라이버 우선 탐색 → 없으면 ChromeDriverManager 자동 설치.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `Placeholder for the real ERP UI automation run on the automatic voucher PC Agent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `Placeholder for the real ERP UI automation run on the automatic voucher PC Agent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `Placeholder for the real ERP UI automation run on the 담당자 PC Agent.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `Placeholder for the real ERP UI automation run on the 담당자 PC Agent.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `분개전표입력 화면 자동 세팅 (v6.1 - Clipboard & UI ID Independence)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 290`** (1 nodes): `?멸툑怨꾩궛??URL(?먮뒗 濡쒖뺄 file:// 寃쎈줈) ??PDF ?ㅼ슫濡쒕뱶 ??寃곌낵 dict 諛섑솚.      諛섑솚媛?`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 291`** (1 nodes): `KT 硫붿씪 紐낆꽭??PDF 泥⑤?瑜???ν븯怨?file:// URI 紐⑸줉 諛섑솚.     ?쒕ぉ ?먮뒗 泥⑤??뚯씪紐낆뿉 'KT emai`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 292`** (1 nodes): `Save tax-invoice XML attachments and return file:// URIs.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 293`** (1 nodes): `硫붿씪 HTML 蹂몃Ц?먯꽌 ?멸툑怨꾩궛???ы꽭 留곹겕留?異붿텧.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 294`** (1 nodes): `?대찓??硫붿떆吏?먯꽌 NTS_eTaxInvoice.html 泥⑤??뚯씪??李얠븘 ?????     file:// URI 諛섑솚. ?놁쑝硫`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 295`** (1 nodes): `硫붿씪 ?섏떊????yymmdd ?뺤떇.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `sleep()` connect `Community 5` to `Community 0`, `Community 32`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 11`, `Community 12`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 28`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `BaseTaxInvoiceHandler` connect `Community 4` to `Community 32`, `Community 33`, `Community 15`, `Community 21`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 21` to `Community 0`?**
