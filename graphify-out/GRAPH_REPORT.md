...
## Corpus Check
- 232 files · ~263,937 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1347 nodes · 4277 edges · 36 communities detected
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 731 edges (avg confidence: 0.78)
...
Cohesion: 0.03
Nodes (102): _acquire_single_instance(), _agent_bundle_hash(), _agent_update_required(), AgentTray, _apply_server_setup_config(), _cert_cache_path(), _cert_store_has_thumbprint(), _cert_thumbprint() (+94 more)
...
Cohesion: 0.06
Nodes (69): _add_installer_file(), _add_installer_tree(), _agent_bootstrap_script(), _agent_cmd_launcher(), _agent_exe_launcher(), _agent_installer_script(), _agent_self_contained_cmd(), _agent_update_notes() (+61 more)

### Community 4 - "Community 4"
Cohesion: 0.13
Nodes (51): api_agent_job_complete(), api_agent_job_event(), api_agent_job_expense_report_upload(), api_agent_job_voucher_upload(), api_analyze_purchase(), api_generate_expense_report(), api_get_invoice_output_set(), api_update_purchase_analysis() (+43 more)
...
Cohesion: 0.15
Nodes (38): build_purchase_erp_payload(), build_regular_erp_payload(), _clean_text(), _configure_pyautogui_for_server(), _corp_codes(), _extract_invoice_date(), _extract_invoice_date_from_text(), _extract_pdf_text_for_date() (+30 more)
...
Cohesion: 0.11
Nodes (13): BaseTaxInvoiceHandler, 메일 본문에서 법인 키워드를 찾아 사업자번호 후보 dict 반환., CsbillHandler, _parse_amount(), _parse_field(), _parse_item_name(), portal_name(), _write_text() (+5 more)
...
Cohesion: 0.18
Nodes (33): api_create_manual_purchase_invoice(), _save_pdf_upload(), _to_int(), _ai_parse(), analyze_purchase_documents(), _clean_match_text(), _clean_text(), _collapse_duplicate_total_prices() (+25 more)
...
Cohesion: 0.2
Nodes (24): _clean_order_no(), _click_print_button(), _close_context(), _compuzone_accounts(), CompuzoneQuoteError, _emit(), fetch_compuzone_quote_pdf(), _find_print_button() (+16 more)
...
- **Thin community `Community 25`** (9 nodes): `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `Backend maintenance tools.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (7 nodes): `admin_viewer.py`, `AILearningViewer`, `.delete_item()`, `.edit_item()`, `.__init__()`, `.load_data()`, `.reset_search()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `SmileEdiHandler` connect `Community 5` to `Community 1`, `Community 10`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `BaseTaxInvoiceHandler` connect `Community 1` to `Community 5`, `Community 10`, `Community 13`, `Community 14`, `Community 20`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `JobStore` connect `Community 3` to `Community 0`, `Community 4`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
