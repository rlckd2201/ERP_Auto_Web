...
## Corpus Check
- 1936 files · ~3,499,931 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4714 nodes · 36967 edges · 62 communities detected
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3015 edges (avg confidence: 0.79)
...
Cohesion: 0.01
Nodes (843): add_invoice_log(), _clean_int(), _columns(), delete_invoice(), detect_invoice_type(), _ensure_column(), get_conn(), get_invoice() (+835 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (54): _check_playwright_runtime(), fetch_approval_documents(), JobEvent, JobRecord, JobStore, utc_now(), InvoiceIdsRequest, JobEventResponse (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (32): _active_invoice_items(), claim_next_erp_task(), now_text(), _read_task(), _task_files(), update_erp_task(), _write_task(), _app_version() (+24 more)
...
Cohesion: 0.04
Nodes (90): AccountStore, AccountUser, hash_password(), make_temporary_password(), now_text(), verify_password(), data_server_target_url(), forward_job_to_data_server() (+82 more)
...
Cohesion: 0.09
Nodes (31): api_agent_job_complete(), completion_mail_body(), notify_job_completed(), notify_password_reset(), password_reset_mail_body(), send_mail(), _write_outbox(), applyAuthUi() (+23 more)
...
Cohesion: 0.23
Nodes (65): _active_install_job(), _add_check(), _age_seconds(), authenticate_user(), change_initial_password(), claim_install_job(), _columns(), complete_install_job() (+57 more)
...
Cohesion: 0.29
Nodes (9): _connection_error_message(), _heartbeat(), main(), _post(), run_loop(), Placeholder for the real ERP UI automation run on the 담당자 PC Agent., _render_print_html(), run_erp_voucher_task() (+1 more)
...
- **Thin community `Community 283`** (1 nodes): `분개전표입력 화면 자동 세팅 (v6.1 - Clipboard & UI ID Independence)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `?멸툑怨꾩궛??URL(?먮뒗 濡쒖뺄 file:// 寃쎈줈) ??PDF ?ㅼ슫濡쒕뱶 ??寃곌낵 dict 諛섑솚.      諛섑솚媛?`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 285`** (1 nodes): `KT 硫붿씪 紐낆꽭??PDF 泥⑤?瑜???ν븯怨?file:// URI 紐⑸줉 諛섑솚.     ?쒕ぉ ?먮뒗 泥⑤??뚯씪紐낆뿉 'KT emai`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 286`** (1 nodes): `Save tax-invoice XML attachments and return file:// URIs.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 287`** (1 nodes): `硫붿씪 HTML 蹂몃Ц?먯꽌 ?멸툑怨꾩궛???ы꽭 留곹겕留?異붿텧.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 288`** (1 nodes): `?대찓??硫붿떆吏?먯꽌 NTS_eTaxInvoice.html 泥⑤??뚯씪??李얠븘 ?????     file:// URI 諛섑솚. ?놁쑝硫`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 289`** (1 nodes): `硫붿씪 ?섏떊????yymmdd ?뺤떇.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `sleep()` connect `Community 6` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 41`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 26`, `Community 28`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `EtaxUnipostHandler` connect `Community 20` to `Community 12`?**
