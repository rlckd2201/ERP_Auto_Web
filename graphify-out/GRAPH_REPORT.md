...
## Corpus Check
- 1941 files · ~3,511,894 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4857 nodes · 37344 edges · 78 communities detected
...
## Knowledge Gaps
- **74 isolated node(s):** `DueRule`, `DueContact`, `DueRule`, `DueContact`, `Run a dry-run print preview or the real legacy ERP automation on the voucher PC` (+69 more)
