...
## Corpus Check
- 1938 files · ~3,504,563 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4760 nodes · 37096 edges · 66 communities detected
...
- `api_regular_due_status()` --calls--> `regular_due_status()`  [INFERRED]
  _codex_app_zoom_agent_patch.py → _codex_stage_zoom_oneclick_enable_fix195_20260622_131614\web_v1\backend\regular_due_monitor.py

## Communities

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (680): add_invoice_log(), _clean_int(), _columns(), delete_invoice(), detect_invoice_type(), _ensure_column(), get_conn(), get_invoice() (+672 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (64): _check_playwright_runtime(), fetch_approval_documents(), JobEvent, JobRecord, JobStore, utc_now(), InvoiceIdsRequest, JobEventResponse (+56 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (67): _app_version(), _env(), _env_bool(), _env_int(), _legacy_manager_path(), _load_env_file(), Settings, _version_file_default() (+59 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (114): main(), RuntimeError, _digits_only(), LG U+ eDocu 전용 처리기.      기준 원칙     - 사업자번호 입력 / 새 사이트 진입 / PDF 저장은 테스트 완료본 흐름, _safe_name(), UplusEdocuHandler, _aggregate_expense_items(), _appdata_template_candidates() (+106 more)
...
Cohesion: 0.04
Nodes (99): AccountStore, AccountUser, hash_password(), make_temporary_password(), now_text(), verify_password(), data_server_target_url(), forward_job_to_data_server() (+91 more)
...
Cohesion: 0.36
Nodes (84): _add_months(), _alert_hour(), _alert_start_date(), _alias_matches_text(), _amount(), build_regular_due_report(), _clean_text(), _compact() (+76 more)

### Community 13 - "Community 13"
Cohesion: 0.21
Nodes (74): _connection_error_message(), _heartbeat(), main(), _post(), run_loop(), _archive_pdf(), _clean_management_items(), _clipboard_account_name() (+66 more)
...
Cohesion: 0.08
Nodes (68): _add_months(), _alert_hour(), _alert_start_date(), _alias_matches_text(), _amount(), build_regular_due_report(), _clean_text(), _compact() (+60 more)
...
## Knowledge Gaps
- **60 isolated node(s):** `DueRule`, `DueContact`, `DueRule`, `DueContact`, `Run a dry-run print preview or the real legacy ERP automation on the voucher PC` (+55 more)
...
- **Thin community `Community 283`** (1 nodes): `Run a dry-run print preview or the real legacy ERP automation on the voucher PC`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 284`** (1 nodes): `Placeholder for the real ERP UI automation run on the automatic voucher PC Agent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `sleep()` connect `Community 7` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 28`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `UplusEDocuHandler` connect `Community 5` to `Community 14`?**
