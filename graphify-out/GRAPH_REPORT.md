...
## Corpus Check
- 1940 files · ~3,510,842 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4843 nodes · 37311 edges · 78 communities detected
...
Cohesion: 0.01
Nodes (732): _active_invoice_items(), claim_next_erp_task(), now_text(), _read_task(), _task_files(), update_erp_task(), _write_task(), add_invoice_log() (+724 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (44): api_agent_admin_next(), api_agent_heartbeat(), api_agent_next(), _client_ip(), AgentHeartbeat, JobStore, _json_dumps(), _json_loads() (+36 more)
...
Cohesion: 0.03
Nodes (102): _connection_error_message(), _download_job_source(), _execute_admin_command(), _heartbeat(), _install_agent_task(), _latest_agent_log(), main(), _popen_hidden() (+94 more)
...
Cohesion: 0.03
Nodes (123): AccountStore, AccountUser, hash_password(), make_temporary_password(), now_text(), protect_secret(), unprotect_secret(), verify_password() (+115 more)
...
Cohesion: 0.38
Nodes (46): _run_real_erp_voucher_task(), build_purchase_erp_payload(), build_regular_erp_payload(), _clean_text(), _configure_pyautogui_for_server(), _corp_codes(), _extract_invoice_date(), _extract_invoice_date_from_text() (+38 more)
...
- **Why does `sleep()` connect `Community 6` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 28`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `AutoEverHandler` connect `Community 30` to `Community 5`?**
