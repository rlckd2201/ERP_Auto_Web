...
## Corpus Check
- 1941 files · ~3,512,397 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4870 nodes · 37377 edges · 82 communities detected
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3135 edges (avg confidence: 0.79)
...
- `_regular_auto_zoom_output_invoices()` --calls--> `list_invoices()`  [INFERRED]
  _codex_app_probe.py → C:\Users\user\Desktop\개발파일\회계업무 자동화_WEB_Version\_release_fix9_stage\web_v1\backend\invoice_db.py
...
Cohesion: 0.01
Nodes (764): _connection_error_message(), _download_job_source(), _execute_admin_command(), _heartbeat(), _install_agent_task(), _latest_agent_log(), main(), _popen_hidden() (+756 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (71): _check_playwright_runtime(), fetch_approval_documents(), _app_version(), _env(), _env_bool(), _env_int(), _legacy_manager_path(), _load_env_file() (+63 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (69): ABC, sleep(), _add_months(), BaseTaxInvoiceHandler, digits_only(), _do_process(), _get_chromedriver_service(), _is_stable() (+61 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (148): AccountStore, AccountUser, hash_password(), make_temporary_password(), now_text(), protect_secret(), unprotect_secret(), verify_password() (+140 more)
...
- **Why does `sleep()` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 26`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `EtaxUnipostHandler` connect `Community 18` to `Community 20`?**
