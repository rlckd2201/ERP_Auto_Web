...
## Corpus Check
- 233 files · ~265,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1363 nodes · 4323 edges · 34 communities detected
...
Cohesion: 0.04
Nodes (119): run_expense_report_task(), _run_self_update(), _upload_expense_report(), _active_invoice_items(), claim_next_erp_task(), now_text(), _read_task(), _task_files() (+111 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (18): loadOverview(), loadTable(), renderRows(), renderTables(), requestJson(), showError(), AppManager, ERPAutoApp (+10 more)
...
Cohesion: 0.08
Nodes (104): accountOptions(), addLog(), agentConnectedFromSetup(), agentUpdateRequiredFromSetup(), applyDetailMode(), applyModeUi(), approvalPaths(), approvalStatusText() (+96 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (41): _agent_update_notes(), api_delete_invoice(), api_get_invoice(), api_get_invoice_logs(), api_list_invoices(), api_retry_invoice(), create_demo_job(), create_job() (+33 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (72): api_create_manual_purchase_invoice(), _check_playwright_runtime(), fetch_approval_documents(), build_purchase_erp_payload(), build_regular_erp_payload(), _clean_text(), _configure_pyautogui_for_server(), _corp_codes() (+64 more)
...
Cohesion: 0.08
Nodes (42): _acquire_single_instance(), _agent_bundle_hash(), _agent_update_required(), AgentTray, _apply_server_setup_config(), _cert_cache_path(), _cert_store_has_thumbprint(), _cert_thumbprint() (+34 more)
...
Cohesion: 0.15
Nodes (34): api_agent_heartbeat(), api_setup_installer(), _active_install_job(), _add_check(), _age_seconds(), authenticate_user(), claim_install_job(), _columns() (+26 more)
...
Cohesion: 0.21
Nodes (23): _clean_order_no(), _click_print_button(), _close_context(), _compuzone_accounts(), CompuzoneQuoteError, _emit(), fetch_compuzone_quote_pdf(), _find_print_button() (+15 more)

### Community 19 - "Community 19"
Cohesion: 0.18
Nodes (7): BaseTaxInvoiceHandler, AutoEverHandler, _normalize_cell(), portal_name(), _table_cells(), _to_int(), _write_text()
...
- **Why does `BaseTaxInvoiceHandler` connect `Community 2` to `Community 6`, `Community 10`, `Community 15`, `Community 19`, `Community 20`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `HometaxHandler` connect `Community 10` to `Community 11`, `Community 2`, `Community 19`?**
