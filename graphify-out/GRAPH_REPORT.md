...
5. `SmileEdiHandler` - 31 edges
6. `add_invoice_log()` - 27 edges
7. `update_invoice_json()` - 26 edges
8. `init_db()` - 25 edges
9. `UplusEdocuHandler` - 24 edges
10. `JobCreateRequest` - 24 edges
...
Cohesion: 0.35
Nodes (25): add_invoice_log(), _clean_int(), _columns(), delete_invoice(), detect_invoice_type(), _ensure_column(), get_conn(), get_invoice_by_pdf_path() (+17 more)

### Community 12 - "Community 12"
Cohesion: 0.2
Nodes (30): api_create_manual_purchase_invoice(), _to_int(), _ai_parse(), analyze_purchase_documents(), _clean_match_text(), _clean_text(), _collapse_duplicate_total_prices(), _extract_amounts_from_tax() (+22 more)

### Community 13 - "Community 13"
Cohesion: 0.16
Nodes (30): api_setup_installer(), _active_install_job(), _add_check(), _age_seconds(), authenticate_user(), claim_install_job(), _columns(), complete_install_job() (+22 more)
...
- **Thin community `Community 25`** (9 nodes): `WEB v1 backend package.`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (9 nodes): `create_https_cert.py`, `create_https_cert.py`, `create_https_cert.py`, `create_https_cert.py`, `create_https_cert.py`, `create_https_cert.py`, `create_https_cert.py`, `main()`, `create_https_cert.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (9 nodes): `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `Backend maintenance tools.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (6 nodes): `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `__init__.py`, `Accounting automation WEB v1 package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `BaseTaxInvoiceHandler` connect `Community 0` to `Community 8`, `Community 14`, `Community 17`, `Community 21`, `Community 22`?**
